...
@interface FourPlayersViewController : UIViewController
{
...
@property (nonatomic, retain) IBOutlet UIImageView *imgYourTurn190CWW;
...
@property (nonatomic, retain) IBOutlet UIButton *btnNumber190CWW;
@property (nonatomic, retain) IBOutlet UIButton *btnNumber290CWW;
@property (nonatomic, retain) IBOutlet UIButton *btnNumber390CWW;
